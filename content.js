      ...
      "changes": [
        ...
        },
        {
          ...
          "desc": {
            ...
            "en": "In this new **Inbox**, you can place customers whose prizes are pending in a queue. This way, you won't lose track of them in the chats.\n**Adding** them to the inbox is simple: just right-click (or press and hold on a mobile device) on the customer’s chat until the menu appears with the “Prize Winner” option. This moves their chat to the prize inbox. To **remove** them from the prize inbox, follow the same steps as above."
          }
        },
        {
          "t": {
        ...
        },
        {
          ...
          "desc": {
            ...
            "en": "The CRM **caches** data on the client side (browser), so even if you log in with a different account, you'll still see the data from your previous account. This is because the **local database** is identified only by account, not by user. Two different users of the **same account** share the same cache."
          }
        },
        {
          "t": {
      ...
      "changes": [
        ...
        },
        {
          "t": {
            ...
            "en": "Mass SMS campaigns with tag-based segmentation."
          }
        },
        {
          "t": {
      ...
      "changes": [
        ...
        },
        {
          "t": {
            ...
            "en": "Tagged: customers, chat priority, and urgent matters."
          }
        }
      ],
      "tags": [
  ...
  "working": [
    {
      ...
      "desc": {
        ...
        "en": "Add WhatsApp features: View/post status updates; Community feed, Channels feed. GIF menu to be implemented.\nAdd the ability to view/interact with reactions, multimedia (for channels and communities), polls, and mentions. All of these features will be available for WAME devices. Due to compatibility issues, the WhatsApp API will not be able to support all of these features."
      },
      "items": [
        {
          "t": {
            "es": "Canales YA implementados.",
            "en": "Channels Already Implemented."
          }
        }
      ],
      "glow": true
  ...
  "terms": [
    ...
    },
    {
      ...
      "p": {
        ...
        "en": "Plans, prices, and billing terms are detailed at the time of enrollment and are subject to change with prior notice."
      }
    },
    {
      "h": {
