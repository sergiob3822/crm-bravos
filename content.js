    ...
    "chips": [
      ...
      },
      {
        ...
        "tip": {
          ...
          "en": "Global SMS and WhatsApp messaging provider with international coverage."
        }
      },
      {
        "label": {
    ...
    "features": [
      ...
      },
      {
        ...
        "desc": {
          ...
          "en": "Link your numbers and launch bulk SMS campaigns to people all over the world."
        }
      },
      {
        "title": {
        ...
        "desc": {
          ...
          "en": "Track the growth of your chats, monitor your agents, and keep an eye on your active lines and unread conversations."
        }
      },
      {
        "title": {
      ...
      },
      {
        ...
        "desc": {
          ...
          "en": "Your information is protected: With two-step verification, the information on your lines is protected."
        }
      },
      {
        "title": {
      ...
      },
      {
        ...
        "desc": {
          ...
          "en": "Ensure your comfort—each line has its own connectors so they don't get mixed up."
        }
      },
      {
        "title": {
      ...
      "changes": [
        {
          ...
          "desc": {
            ...
            "en": "\t- **OCR** has been updated, offering you personalized and detailed training on receipts.\n\t- A **vision** detection system was implemented to enhance the **OCR** reader.\n- The reader’s accuracy **was improved**.\n- Response times for verifying receipts and the wallet **were reduced**.\n"
          }
        },
        {
          "t": {
      ...
      "changes": [
        ...
        },
        {
          ...
          "desc": {
            ...
            "en": "In this new **Inbox**, you can place customers whose prizes are pending in a queue. This way, you won't lose track of the customer in the chats.\n**Adding** them to the inbox is easy—just right-click (or press and hold on a mobile device) the customer’s chat until the menu appears with the “Prize Winner” option. This will move their chat to the prize inbox. To **remove** them from the prize inbox, just repeat the same steps."
          }
        },
        {
          "t": {
          ...
          "desc": {
            ...
            "en": "The errors to note are:\n- The **PDF download** feature was not working: when attempting to download a received PDF or document, the CRM did nothing. This was because the download button was **incorrectly redirecting to the document**.\n- *Incorrect menu resizing**: When accessing a settings tab, the tabs were displayed in desktop mode, which **cropped out several functions** and buttons on the tab, preventing the agent/moderator from working properly or changing settings. \n- **The settings menu did not work as intended**: When clicking the settings gear icon to display the features, it would **automatically** redirect us to _Account Settings_. This only occurred in Android versions 1.0 and 1.1, so it has already been [green]fixed[/green]."
          }
        },
        {
          "t": {
      ...
      "changes": [
        ...
        },
        {
          "t": {
            ...
            "en": "Fixed the \"missing messages\" bug (some agents weren't seeing certain messages in the chat)."
          }
        },
        {
          "t": {
      ...
      "changes": [
        ...
        },
        {
          "t": {
            ...
            "en": "Tagged under customers, chat priority, and urgency."
          }
        }
      ],
      "tags": [
  ...
  "working": [
    {
      ...
      "desc": {
        "es": "\t- **Implementación de billetera RIVEN**.\n\t- **Se van a agregar más plataformas dentro de pinacclebot**.\n\t- **Cambio de diseño en los grupos**: Se busca que los chats tengan foto de perfil y que, al clickear el número, se despliegue el menú de opciones como en whatsapp (Agregar contacto y enviar mensaje).\n\t- **Implementación de métrica Global**: va a mostrar una sheet de google con datos en tiempo real que se pueden modificar.\n\t- **Optimizar PinaccleBot**: La finalidad es disminuír el consumo de memoria RAM, sin perder rendimiento.",
        "en": "\t- **Implementation of the RIVEN wallet**.\n  - **More platforms will be added to Pinacclebot**.\n\t- **Design changes to groups**: The goal is for chats to have profile pictures and, when you click on the number, for the options menu to appear, similar to WhatsApp (Add Contact and Send Message).\n\t- **Implementation of Global Metrics**: This will display a Google Sheet with real-time data that can be modified.\n  - **Optimize PinaccleBot**: The goal is to reduce RAM usage without sacrificing performance."
      },
      "items": [],
      "glow": true
    },
    {
      ...
      "desc": {
        ...
        "en": "A bot that automates tasks on the Ganamos platform (creating user accounts, withdrawing tokens, loading tokens) and with certain S.A. banks that provide API keys (checking for incoming transfers). The goal is to ensure that your cashier never has to leave the platform."
      },
      "items": [
        {
          "t": {
