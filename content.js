    ...
    "features": [
      ...
      },
      {
        ...
        "desc": {
          ...
          "en": "Track the growth of your chats, monitor your agents, and keep an eye on your active lines and unread messages."
        }
      },
      {
        "title": {
      ...
      "changes": [
        ...
        },
        {
          ...
          "desc": {
            ...
            "en": "In this new **Inbox**, you can place customers whose prizes are pending in a queue. This way, you won't lose track of the customer in the chats.\n**Adding** them to the inbox is simple: just right-click (or press and hold on a mobile device) the customer’s chat until the menu appears with the “Prize Winner” option. This will move their chat to the prize inbox. To **remove** them from the prize inbox, follow the same steps as above."
          }
        },
        {
          "t": {
      ...
      "changes": [
        ...
        },
        {
          "t": {
            ...
            "en": "Correction regarding Baileys: It didn't link to WhatsApp Business, but it did link to WhatsApp Messenger."
          }
        },
        {
          "t": {
  ...
  "working": [
    {
      ...
      "title": {
        "es": "BravosCRM v0.015.8",
        "en": "BravosCRM v0.015.8"
      },
      "desc": {
        "es": "Agregar funcionalidades de whatsapp: Ver/subir estados; bandeja de comunidad, bandeja de canales.Menú de GIF's a implementar\nAgragar la posibilidad de ver/interactuar con reacciones, multimedia (en caso de canales y comunidad), encuestas y menciones. Todas estas implementaciones serán disponibles para las líneas WAME. Por temas de compatibilidad, whatsapp api no van a poder tener todas estas ventajas.",
        "en": "Add WhatsApp features: View/post status updates; Community feed, Channels feed. GIF menu to be implemented.\nAdd the ability to view/interact with reactions, multimedia (for channels and communities), polls, and mentions. All of these features will be available for WAME versions. Due to compatibility issues, the WhatsApp API will not be able to support all of these features."
      },
      "items": [
        {
          "t": {
            "es": "Reacciones: Se puede visualizar las reacciones de los mensajes y realizarlas.",
            "en": "Reactions: You can view reactions to messages and post them."
          }
        },
        {
          "t": {
            "es": "Encuestas funcionales: Se pueden realizar encuestas, ver encuestas, votarlas y ver los votos.",
            "en": "Feature Polls: You can create polls, view polls, vote on them, and see the votes."
          }
        },
        {
          "t": {
            "es": "Canales implementados: Menú de canales apartado del chat (diseño completo hecho de 0).",
            "en": "Channels implemented: Channel menu separate from the chat (design created from scratch)."
          }
        }
      ],
      "glow": true
    },
    {
      ...
      "desc": {
        ...
        "en": "A bot that automates tasks using the Ganamos platform (creating user accounts, withdrawing tokens, loading tokens) and certain S.A. banks that provide API keys (checking for incoming transfers). The goal is to ensure that your teller does not have to leave the platform."
      },
      "items": [
        {
          "t": {
        ...
        },
        {
          "t": {
            ...
            "en": "In PinaccleBot, you can manually assign players to customers. This way, if you already had customers before using Pinaccle, you can enter their player usernames to save them in the database."
          }
        }
      ],
      "glow": true,
