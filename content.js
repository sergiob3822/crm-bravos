    ...
    "features": [
      ...
      },
      {
        ...
        "desc": {
          ...
          "en": "Link your phone numbers and launch bulk SMS campaigns worldwide."
        }
      },
      {
        "title": {
      ...
      "changes": [
        ...
        },
        {
          ...
          "desc": {
            ...
            "en": "The error persisted due to a **duplicate** in the Cloudflare tunnels. This occurred with their latest update. It was resolved by recreating the CRM's connections to the domain and Cloudflare."
          }
        },
        {
          "t": {
      ...
      "changes": [
        ...
        },
        {
          "t": {
            ...
            "en": "\"Export Contacts\" fix: It wasn't reading the work email and was throwing an error."
          }
        }
      ],
      "tags": [
      ...
      "items": [
        ...
        },
        {
          "t": {
            ...
            "en": "PinaccleBot automatically verifies transfers and credits chips: When a transfer arrives, Pinaccle requests authorization to review it; once authorized, it verifies that the amount has been credited to the bank account and automatically credits tokens (if the user exists in the Pinaccle database)."
          }
        },
        {
          "t": {
  ...
  "terms": [
    ...
    },
    {
      ...
      "p": {
        ...
        "en": "You are responsible for your account information and your agents' credentials. Each user can set up two-step verification (2FA) when their account is created."
      }
    },
    {
      "h": {
    ...
    },
    {
      ...
      "p": {
        ...
        "en": "Plans, prices, and billing terms are specified at the time of sign-up and are subject to change with prior notice."
      }
    },
    {
      "h": {
